...
This repository contains a **Finance Dashboard built in Power BI**, designed to provide insights into **Sales, Profit, Discounts, and Cost of Goods Sold (COGS)** across multiple dimensions such as **Products, Segments, and Locations**.  

---

### 🔗 **Live Dashboard**
👉 [View on Power BI](https://app.powerbi.com/groups/me/reports/0d2d99d0-ff04-493f-86ba-d8c31398387e/bbcad33b196a40c7ba87?experience=power-bi)  

---

### 📂 **Dataset**
- **Source**: [Finance Data (Kaggle)](https://www.kaggle.com/datasets/nitindatta/finance-data)  
- 📌 Tip: Clicking on the **Finance Dashboard image (top left corner)** inside Power BI will navigate to the dataset link.  
